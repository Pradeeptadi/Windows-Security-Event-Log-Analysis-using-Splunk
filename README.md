...
Top Active Accounts	Count of logons by user	Bar Chart
Logon Type Distribution	Local, network, RDP	Pie Chart
Failed vs Successful Logons	4624 vs 4625	Area Chart
Login Timeline (Per Hour)	Login patterns by hour	Line Chart
Privilege Escalation Events	Event 4672 details	Table
Log Clearing Attempts	Event 1102	Single Value (Alert Red)
🧠 Findings
